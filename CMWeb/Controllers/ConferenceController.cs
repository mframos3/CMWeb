...
namespace CMWeb.Controllers
{
    public class ConferenceController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,StartDate,EndDate,Sponsors")] Conference conference)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,StartDate,EndDate,Sponsors")] Conference conference)
        {
            if (id != conference.Id)
            {
                return NotFound();
